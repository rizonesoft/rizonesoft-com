...
Donate link: https://rizonepress.com
...
I developed the Gluon Download Manager plugin because I needed a nice way to manage my digital downloads and monitor the number of downloads of my files and documents.
...
= Gluon Download Manager Features =
...
* Option to add additional security to your downloadable files with the [Enhanced File Protection Feature](https://gluon-download-manager.com/enhanced-file-protection-securing-your-downloads/).
...
* Option to specify file size info so it can be shown to your visitors. [View the tutorial](https://gluon-download-manager.com/how-to-show-file-size-info-of-your-downloads/)
...
* Option to restrict downloads to logged-in users only. [View the tutorial](https://gluon-download-manager.com/offering-downloads-to-logged-in-users-members-only/)
...
View more details on the [download monitor plugin](https://gluon-download-manager.com/) page.
...
= Gluon Download Manager Plugin Usage =
...
View more usage instructions on the [Download Monitor Plugin](https://gluon-download-manager.com/) page.

== Github Repository ==

https://github.com/Arsenal21/gluon-download-manager
...
1. Browse for the plugin file (gluon-download-manager.zip)
1. Click Install Now and then activate the plugin

== Frequently Asked Questions ==

= Where can I find complete documentation for this plugin? =
You can find the full documentation for this plugin on the [Gluon Download Manager plugin documentation](https://gluon-download-manager.com/download-monitor-tutorials/) page.
...
You can add additional security to your downloadable files with the [Enhanced File Protection Feature](https://gluon-download-manager.com/enhanced-file-protection-securing-your-downloads/).
...
= 3.9.31 =
- Cloudflare Turnstile CAPTCHA support added. View the [Cloudflare Turnstile CAPTCHA documentation](https://gluon-download-manager.com/using-cloudflare-turnstile-captcha-with-the-gluon-download-manager/) for more details.
...
= 3.9.25 =
- New [Enhanced File Protection](https://gluon-download-manager.com/enhanced-file-protection-securing-your-downloads/) feature added.
...
- The 'more details' Shortcode usage example is available in the [documentation here](https://gluon-download-manager.com/miscellaneous-shortcodes-and-shortcode-parameters/#showing-a-more-details-link)
...
Full changelog available [at change-log-of-old-versions.txt](https://plugins.svn.wordpress.org/gluon-download-manager/trunk/change-log-of-old-versions.txt)
