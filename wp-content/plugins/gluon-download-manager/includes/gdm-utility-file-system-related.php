...
class GDM_Utils_File_System_Related {
	...
	public static function check_is_file_extension_allowed($file_path){
		...
		$disallowed_ext_opt = empty( $main_option['general_disallowed_file_ext_dispatch'] ) ? gluonDownloadManager::$disallowed_ext_dispatch_def : $main_option['general_disallowed_file_ext_dispatch'];
