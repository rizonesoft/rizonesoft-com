<?php
$output = '';
wp_enqueue_style( 'GDM_addons_listing', WP_GLUON_DL_MANAGER_URL . '/css/gdm_addons_listing.css', array(), WP_GLUON_DL_MANAGER_VERSION );
?>
...
<div class="wrap">
	...
	<div id="poststuff"><div id="post-body">
			...
			$addon_1 = array(
				...
				'thumbnail'   => WP_GLUON_DL_MANAGER_URL . '/images/addons/gdm-squeeze-form-addon-icon.png',
			...
			$addon_2 = array(
				...
				'thumbnail'   => WP_GLUON_DL_MANAGER_URL . '/images/addons/gdm-email-on-download-addon-icon.png',
			...
			$addon_3 = array(
				...
				'thumbnail'   => WP_GLUON_DL_MANAGER_URL . '/images/addons/gdm-hidden-downloads-addon-icon.png',
			...
			$addon_4 = array(
				...
				'thumbnail'   => WP_GLUON_DL_MANAGER_URL . '/images/addons/gdm-amazon-s3-addon-icon.png',
			...
			$addon_5 = array(
				...
				'thumbnail'   => WP_GLUON_DL_MANAGER_URL . '/images/addons/gdm-allow-uploads-addon-icon.png',
			...
			$addon_6 = array(
				...
				'thumbnail'   => WP_GLUON_DL_MANAGER_URL . '/images/addons/gdm-dropbox-integration-addon.png',
			...
			$addon_7 = array(
				...
				'thumbnail'   => WP_GLUON_DL_MANAGER_URL . '/images/addons/gdm-emember-integration.png',
			...
			foreach ( $addons_data as $addon ) {
				$output .= '<div class="GDM_addon_item_canvas">';

				$output .= '<div class="GDM_addon_item_thumb">';
				$img_src = $addon['thumbnail'];
				$output .= '<img src="' . $img_src . '" alt="' . $addon['name'] . '">';
				$output .= '</div>'; //end thumbnail

				$output .= '<div class="GDM_addon_item_body">';
				$output .= '<div class="GDM_addon_item_name">';
				$output .= '<a href="' . $addon['page_url'] . '" target="_blank">' . $addon['name'] . '</a>';
				$output .= '</div>'; //end name

				$output .= '<div class="GDM_addon_item_description">';
				$output .= $addon['description'];
				$output .= '</div>'; //end description

				$output .= '<div class="GDM_addon_item_details_link">';
				$output .= '<a href="' . $addon['page_url'] . '" class="GDM_addon_view_details" target="_blank">View Details</a>';
