...
registerBlockType('gluon-download-manager/download-item', {
	...
	edit: function (props) {
		return [
			el(ServerSideRender, {
				block: 'gluon-download-manager/download-item',
				attributes: props.attributes,
			}),
			el(InspectorControls, {}, el('div', {className: "gdm-download-block-ic-wrapper"}, [
					el(SelectControl, {
